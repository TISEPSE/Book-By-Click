 ...
 * Contient les liens de navigation, support, réseaux sociaux et copyright.
 */
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
              ...
              solution simple, efficace et sécurisée pour tous vos besoins de planning.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: "https://tisepse.github.io/Documentation-BBC/", label: "Documentation", external: true },
