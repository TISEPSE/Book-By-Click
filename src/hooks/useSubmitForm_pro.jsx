...
/**
 * Hook personnalisé pour la soumission du formulaire d'inscription professionnel.
 *
 * Gère la sérialisation des données du formulaire, l'appel API et l'affichage
 * d'un toast de retour (succès ou erreur).
 * En cas de succès, redirige vers /login via sessionStorage pour afficher
 * le toast de confirmation sur la page suivante.
 *
...
export default function useSubmitForm_pro(url, successMessage, errorMessage) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        // Persistance du toast en sessionStorage pour l'afficher après redirection
